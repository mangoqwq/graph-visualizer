...
function CommandBar(props: { children: React.ReactNode }) {
	return (
		<div className="flex border-solid border-2 justify-between">
			{props.children}
		</div>
	);
}
	...
	return (
		<div className="w-2/6 h-full m-2 p-2">
			<CommandBar>
				...
				<button onClick={() => setMenu({ type: "markup" })}>Markup</button>
